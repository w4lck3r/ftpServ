...
public class FTPServer{
	 ...
	 private static void handleClient(Socket clientSocket) throws IOException {
		try (InputStream inputStream = clientSocket.getInputStream();
			...
			String currentDirectory = "C:\\Users\\badr-\\Downloads\\Car\\tp1";
	 ...
	 private static void handleDirCommand(String currentDirectory, OutputStream outputStream) throws IOException {
		...
		if (Files.isDirectory(directoryPath)) {
			...
			sendResponse(outputStream, "550 Requested action not taken. Directory not found or is not a directory.\r\n");
		}
	}

	private static String handleCdCommand(Scanner scanner, String currentDirectory, OutputStream outputStream) throws IOException {
